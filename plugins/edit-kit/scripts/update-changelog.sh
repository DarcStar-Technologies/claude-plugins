#!/usr/bin/env bash
# update-changelog.sh — part of the edit-kit toolkit (resolved at run time by
# plugin-editor and template-editor). Record a change in a target's CHANGELOG.md under
